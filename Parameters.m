...
% Global_Mass_Matrix=[   54.0945         0         0         0   -0.0330         0;
%          0  122.3984         0    0.1439         0   -1.9543;
%          0         0  121.1792         0    1.5703         0;
%          0    0.1439         0    0.8385         0   -0.0353;
%    -0.0330         0    1.5703         0   26.5838         0;
%          0   -1.9543         0   -0.0353         0   26.6822];
Para.Mg=diag(diag(Global_Mass_Matrix));
...
% KqCylinder=[27.0059         0         0         0         0         0;
%          0   55.2000         0         0         0         0;
%          0         0   55.2000         0         0         0;
%          0         0         0    0.0136         0         0;
%          0         0         0         0   18.8416         0;
%          0         0         0         0         0   18.8416];
Para.S0.Kq = -diag(diag(KqCylinder));
...
Para.S1.Kq = -diag(diag(KqAntenna));
...
% KqThruster=[ 0.7540         0         0         0         0         0;
%          0   12.4800         0         0         0         0;
%          0         0   15.6000         0         0         0;
%          0         0         0    0.0008         0         0;
%          0         0         0         0    0.0228         0;
%          0         0         0         0         0    0.0183];
Para.S2.Kq = -diag(diag(KqThruster));
Para.S3.Kq = -diag(diag(KqThruster));
...
global int_delta_z0 int_delta_Vsurge0 step1 step2 step3 c
int_delta_z0=0;
int_delta_Vsurge0=0;
step1=1;
step2=0;
